...
from task.views import SGCRetrieveAPIView, SGCListAPIView, ServiceListAPIView , ServiceRetrieveAPIView, ServiceCreateAPIView, SGCCreateAPIView, UserListView, UserRegistrationView, UserLoginView
...
urlpatterns = [
    ...
    path('sgc/', SGCListAPIView.as_view(), name='sgc-list'),
